...
<?php if(!$listeProduits) { ?>
	...
	<?php foreach($listeProduits as $produits) { ?>
		...
		<tr><td><?php print $produits ['name'] ?></td>
		    <td><?php print $produits ['price'] ?></td>
			<td><?php print $produits ['quantite'] ?></td>
			<td><a href="confirmation.php?id=<?php print $produits['id'] ?>"> Confirmer </a>
			<a href="selection.php?id=<?php print $produits['id'] ?>"> Modifier </a>
			<a href="suppression.php?id=<?php print $produits['id'] ?>"> Supprimer </a></td> </tr> 
        <?php } ?></center>
	</table>
<?php } ?>
</br> 
